...
def make_c_custom(instr_dict):
    ...
    {spike_make}
    ''')
    enc_file_spike.close()
    
    enc_file2 = open('riscv-opc.out.c','w')
    enc_file2.write(f'''{insn_str}''')
    enc_file2.close()
...
if __name__ == "__main__":
    ...
    # make_c_custom(instr_dict_c)
    # logging.info('encoding.out.h & riscv-opcodes generated successfully')
