...
//=========================
// Polar 2 regs  
{"pl.f",      0, INSN_CLASS_I, "d,s,t", MATCH_PL_F, MASK_CST,      match_opcode, 0 },
{"pl.r",      0, INSN_CLASS_I, "d,s,t", MATCH_PL_R, MASK_CST,      match_opcode, 0 },
{"pl.addsat", 0, INSN_CLASS_I, "d,s,t", MATCH_PL_ADDSAT, MASK_CST, match_opcode, 0 },
{"pl.subsat", 0, INSN_CLASS_I, "d,s,t", MATCH_PL_SUBSAT, MASK_CST, match_opcode, 0 },
{"pl.decode", 0, INSN_CLASS_I, "d,s,t", MATCH_PL_DECODE, MASK_CST, match_opcode, 0 },
{"pl.eval",   0, INSN_CLASS_I, "d,s,t", MATCH_PL_EVAL,   MASK_CST, match_opcode, 0 },

{"pl.rep_addhi",   0, INSN_CLASS_I, "d,s,t", MATCH_PL_REP_ADDHI,   MASK_CST, match_opcode, 0 },
{"pl.rep_addlo",   0, INSN_CLASS_I, "d,s,t", MATCH_PL_REP_ADDLOW,  MASK_CST, match_opcode, 0 },
{"pl.rep_addsign", 0, INSN_CLASS_I, "d,s,t", MATCH_PL_REP_ADDSIGN, MASK_CST, match_opcode, 0 },

{"pl.spc_acmp",  0, INSN_CLASS_I, "d,s,t", MATCH_PL_SPC_ACMP, MASK_CST, match_opcode, 0 },
{"pl.spc_amin",  0, INSN_CLASS_I, "d,s,t", MATCH_PL_SPC_AMIN, MASK_CST, match_opcode, 0 },
{"pl.spc_idup",  0, INSN_CLASS_I, "d,s,t", MATCH_PL_SPC_IDUP, MASK_CST, match_opcode, 0 },
{"pl.spc_max",   0, INSN_CLASS_I, "d,s,t", MATCH_PL_SPC_MAX,  MASK_CST, match_opcode, 0 },

{"pl.rep_addsum", 0, INSN_CLASS_I, "d,s,t", MATCH_PL_REP_ADDSUM, MASK_CST, match_opcode, 0 },
{"pl.spc_xorsum", 0, INSN_CLASS_I, "d,s,t", MATCH_PL_SPC_XORSUM, MASK_CST, match_opcode, 0 },
{"pl.spc_minapos",    0, INSN_CLASS_I, "d,s,t", MATCH_PL_SPC_MINAPOS, MASK_CST, match_opcode, 0 },

//  Polar 3 regs 
{"pl3_g",            0, INSN_CLASS_I, "d,s,t,r", MATCH_PL3_G, MASK_R4_CST, match_opcode, 0 },
{"pl3_idx_min_comp", 0, INSN_CLASS_I, "d,s,t,r", MATCH_PL3_IDX_MIN_COMP, MASK_R4_CST, match_opcode, 0 },
{"pl3_sc_update",    0, INSN_CLASS_I, "d,s,t,r", MATCH_PL3_SC_UPDATE, MASK_R4_CST, match_opcode, 0 },
{"pl3_find_min_pos", 0, INSN_CLASS_I, "d,s,t,r", MATCH_PL3_FINDMINPOS, MASK_R4_CST, match_opcode, 0 },
//=========================

// ldpc 
{"ld.sign",     0, INSN_CLASS_I,    "d,s,t",  MATCH_SIGN,      MASK_CST, match_opcode, 0 },
{"ld.abs",      0, INSN_CLASS_I,    "d,s,t",  MATCH_ABS,       MASK_CST, match_opcode, 0 },
{"ld.max",      0, INSN_CLASS_I,    "d,s,t",  MATCH_LD_MAX ,   MASK_CST, match_opcode, 0 },
{"ld.min",      0, INSN_CLASS_I,    "d,s,t",  MATCH_LD_MIN,    MASK_CST, match_opcode, 0 },
{"ld.sign2",    0, INSN_CLASS_I,    "d,s,t",  MATCH_SIGN2,     MASK_CST, match_opcode, 0 },
{"ld.nmess",    0, INSN_CLASS_I,    "d,s,t",  MATCH_NMESS,     MASK_CST, match_opcode, 0 },
{"ld.subsat",   0, INSN_CLASS_I,    "d,s,t",  MATCH_LD_SUBSAT, MASK_CST, match_opcode, 0 },

// kit v2 
{"ld.eval",     0, INSN_CLASS_I,    "d,s,t",  MATCH_EVAL,      MASK_CST, match_opcode, 0 },
{"ld.rsign",    0, INSN_CLASS_I,    "d,s,t",  MATCH_RSIGN,     MASK_CST, match_opcode, 0 },
{"ld.addsat",   0, INSN_CLASS_I,    "d,s,t",  MATCH_INVMINAND, MASK_CST, match_opcode, 0 },
{"ld.storeu",   0, INSN_CLASS_I,    "d,s,t",  MATCH_IABS,      MASK_CST, match_opcode, 0 },

//ldpc nb  
{"ldn.add32u_sat64" ,   0, INSN_CLASS_I,   "d,s,t",  MATCH_LDN_ADDSAT1,   MASK_CST, match_opcode, 0 },
// {"ldn.xor"          ,   0, INSN_CLASS_I,   "d,s,t",  MATCH_LDN_XOR,       MASK_CST, match_opcode, 0 },
{"ldn.min",             0, INSN_CLASS_I,   "d,s,t",  MATCH_LDN_MIN,       MASK_CST, match_opcode, 0 },
{"ldn.sat8u",           0, INSN_CLASS_I,   "d,s,t",  MATCH_LDN_SAT8,      MASK_CST, match_opcode, 0 },
{"ldn.add32s_sat64",    0, INSN_CLASS_I,   "d,s,t",  MATCH_LDN_ADDSAT2,   MASK_CST, match_opcode, 0 },
{"ldn.sub32s_sat64",    0, INSN_CLASS_I,   "d,s,t",  MATCH_LDN_SUBSAT,    MASK_CST, match_opcode, 0 },

{"ldn.vidxmincomp",     0, INSN_CLASS_I,   "d,s,t",  MATCH_LDN_VIDXMINCOMP,    MASK_CST, match_opcode, 0 },
{"ldn.vidxminupdate",   0, INSN_CLASS_I,   "d,s,t",  MATCH_LDN_VIDXMINUPDATE,  MASK_CST, match_opcode, 0 },
{"ldn.vidxminupdate2",  0, INSN_CLASS_I,   "d,s,t",  MATCH_LDN_VIDXMINUPDATE2,  MASK_CST, match_opcode, 0 },

// just in case some more instructions 
{"vadds_4x8b",      0, INSN_CLASS_I,   "d,s,t",  MATCH_CST0,    MASK_CST, match_opcode, 0 },
{"vsubs_4x8b",      0, INSN_CLASS_I,   "d,s,t",  MATCH_CST1,    MASK_CST, match_opcode, 0 },
{"vmaxs_4x8b",      0, INSN_CLASS_I,   "d,s,t",  MATCH_CST2,    MASK_CST, match_opcode, 0 },
{"vadds_sll1_4x8b", 0, INSN_CLASS_I,   "d,s,t",  MATCH_CST3,    MASK_CST, match_opcode, 0 },
{"vsubs_4x8b_1x8b", 0, INSN_CLASS_I,   "d,s,t",  MATCH_CST4,    MASK_CST, match_opcode, 0 },
{"tb.vscale",       0, INSN_CLASS_I,   "d,s,t",  MATCH_CST5,    MASK_CST, match_opcode, 0 },
{"vis_mins_4x8b",   0, INSN_CLASS_I,   "d,s,t",  MATCH_CST6,    MASK_CST, match_opcode, 0 },
{"cst7",            0, INSN_CLASS_I,   "d,s,t",  MATCH_CST7,    MASK_CST, match_opcode, 0 },


// extended customs 
{"shuffle", 0, INSN_CLASS_I,   "d,s,t",  MATCH_CST8,     MASK_CST, match_opcode, 0 },
{"vabs"   , 0, INSN_CLASS_I,   "d,s,t",  MATCH_CST9,     MASK_CST, match_opcode, 0 },
{"vsubs"  , 0, INSN_CLASS_I,   "d,s,t",  MATCH_CST10,    MASK_CST, match_opcode, 0 },
{"vadds"  , 0, INSN_CLASS_I,   "d,s,t",  MATCH_CST11,    MASK_CST, match_opcode, 0 },
// singed in fact 
{"vmaxu"  , 0, INSN_CLASS_I,   "d,s,t",  MATCH_CST12,    MASK_CST, match_opcode, 0 },
{"vminu"  , 0, INSN_CLASS_I,   "d,s,t",  MATCH_CST13,    MASK_CST, match_opcode, 0 },
{"vsrls"  , 0, INSN_CLASS_I,   "d,s,t",  MATCH_CST14,    MASK_CST, match_opcode, 0 },


{"ld3_rsign_nmess"  , 0, INSN_CLASS_I,   "d,s,t,r",  MATCH_LD3_RSING_NMESS,   MASK_LD3_RSING_NMESS  , match_opcode, 0 },
{"ld3_copyxorvecto" , 0, INSN_CLASS_I,   "d,s,t,r",  MATCH_LD3_COPYXORVECTO,  MASK_LD3_COPYXORVECTO , match_opcode, 0 },
{"ld3_maxsub"       , 0, INSN_CLASS_I,   "d,s,t,r",  MATCH_LD3_MAXSUB,        MASK_LD3_MAXSUB       , match_opcode, 0 },
{"ld3_min_sorting"  , 0, INSN_CLASS_I,   "d,s,t,r",  MATCH_LD3_MIN_SORTING,   MASK_LD3_MIN_SORTING  , match_opcode, 0 },
{"ld3_minmax"       , 0, INSN_CLASS_I,   "d,s,t,r",  MATCH_LD3_MINMAX ,       MASK_LD3_MINMAX       , match_opcode, 0 },
{"ld3_readvn"       , 0, INSN_CLASS_I,   "d,s,t,r",  MATCH_LD3_READVN ,       MASK_LD3_READVN       , match_opcode, 0 },
{"ld3_sign3"        , 0, INSN_CLASS_I,   "d,s,t,r",  MATCH_LD3_SIGN3 ,        MASK_LD3_SIGN3        , match_opcode, 0 },
