...
#define MASK_CST                 0xfe00707f
#define MASK_ICST                    0x707f
#define MASK_R4_CST              0x0600707F
//=========================
// POLAR 
//=========================
#define MATCH_PL_F         0x2b
#define MASK_PL_F          0xfe00707f
#define MATCH_PL_R         0x102b
#define MASK_PL_R          0xfe00707f
#define MATCH_PL_ADDSAT    0x202b
#define MASK_PL_ADDSAT     0xfe00707f
#define MATCH_PL_SUBSAT    0x302b
#define MASK_PL_SUBSAT     0xfe00707f
#define MATCH_PL_DECODE    0x402b
#define MASK_PL_DECODE     0xfe00707f
#define MATCH_PL_EVAL      0x502b
#define MASK_PL_EVAL       0xfe00707f
//=========================

#define MATCH_PL_REP_ADDHI    0x702b
#define MASK_PL_REP_ADDHI     0xfe00707f
#define MATCH_PL_REP_ADDLOW   0x602b
#define MASK_PL_REP_ADDLOW    0xfe00707f
#define MATCH_PL_REP_ADDSIGN  0x200002b
#define MASK_PL_REP_ADDSIGN   0xfe00707f
//=========================

#define MATCH_PL_SPC_ACMP     0x200102b
#define MASK_PL_SPC_ACMP      0xfe00707f
#define MATCH_PL_SPC_AMIN     0x200202b
#define MASK_PL_SPC_AMIN      0xfe00707f
#define MATCH_PL_SPC_IDUP     0x200302b
#define MASK_PL_SPC_IDUP      0xfe00707f
#define MATCH_PL_SPC_MAX      0x200402b
#define MASK_PL_SPC_MAX       0xfe00707f
//=========================

#define MATCH_PL_REP_ADDSUM   0x200502b
#define MASK_PL_REP_ADDSUM    0xfe00707f
#define MATCH_PL_SPC_XORSUM   0x200602b
#define MASK_PL_SPC_XORSUM    0xfe00707f
#define MATCH_PL_SPC_MINAPOS  0x200702b
#define MASK_PL_SPC_MINAPOS   0xfe00707f
//=========================

#define MATCH_PL3_G              0x600002b
#define MASK_PL3_G               0x600707f
#define MATCH_PL3_IDX_MIN_COMP  0x600102b
#define MASK_PL3_IDX_MIN_COMP   0x600707f
#define MATCH_PL3_SC_UPDATE     0x600202b
#define MASK_PL3_SC_UPDATE      0x600707f
//=========================

#define MATCH_PL3_FINDMINPOS  0x600302b
#define MASK_PL3_FINDMINPOS   0x600707f
...
// LDPC defs ( keep using mask cst ) 0x0b
#define MATCH_SIGN          0x0000000b
#define MATCH_ABS           0x0000100b
#define MATCH_LD_MAX        0x0000200b
#define MATCH_LD_MIN        0x0000300b
#define MATCH_NMESS         0x0000400b
#define MATCH_LD_SUBSAT     0x0000500b
#define MATCH_SIGN2         0x0000700b

#define MATCH_IABS          0x0000600b
#define MASK_IABS           0xfff0707f  

// kit v2 : necessite fc7 
#define MATCH_EVAL          0x0200000b
#define MATCH_RSIGN         0x0200100b
#define MATCH_INVMINAND     0x0200200b

#define MATCH_CUSTOM        0x0200000b


//LDPC NB 0x7b
#define MATCH_LDN_ADDSAT1        0x0000007b
#define MATCH_LDN_VIDXMINUPDATE2 0x0000107b
#define MATCH_LDN_MIN            0x0000207b
#define MATCH_LDN_SAT8           0x0000307b
#define MATCH_LDN_ADDSAT2        0x0000407b
#define MATCH_LDN_SUBSAT         0x0000507b
#define MATCH_LDN_VIDXMINCOMP    0x0000607b
#define MATCH_LDN_VIDXMINUPDATE  0x0000707b


// randoms instrus x5b
#define MATCH_CST0      0x0000005b
#define MATCH_CST1      0x0000105b
#define MATCH_CST2      0x0000205b
#define MATCH_CST3      0x0000305b
#define MATCH_CST7      0x0000505b
#define MATCH_CST4      0x0000405b
#define MATCH_CST5      0x0000605b
#define MATCH_CST6      0x0000705b
// extended to fc7 
#define MATCH_CST8      0x0200105b
#define MATCH_CST9      0x0200205b
#define MATCH_CST10     0x0200305b
#define MATCH_CST11     0x0200405b
#define MATCH_CST12     0x0200505b
#define MATCH_CST13     0x0200605b  
#define MATCH_CST14     0x0200705b

#define MATCH_LD3_RSING_NMESS    0x600200b
#define MASK_LD3_RSING_NMESS     0x600707f
#define MATCH_LD3_COPYXORVECTO   0x600500b
#define MASK_LD3_COPYXORVECTO    0x600707f
#define MATCH_LD3_MAXSUB         0x600400b
#define MASK_LD3_MAXSUB          0x600707f
#define MATCH_LD3_MIN_SORTING    0x600300b
#define MASK_LD3_MIN_SORTING     0x600707f
#define MATCH_LD3_MINMAX         0x600100b
#define MASK_LD3_MINMAX          0x600707f
#define MATCH_LD3_READVN         0x600600b
#define MASK_LD3_READVN          0x600707f
#define MATCH_LD3_SIGN3          0x600000b
#define MASK_LD3_SIGN3           0x600707f
